...
INSERT INTO client_details (client_id, client_name, logo_uri, access_token_validity_seconds, token_endpoint_auth_method) VALUES
  ('patient_data_manager', 'Patient Data Manager App', 'https://sandbox.hspconsortium.org/hsp-patient-data-manager/static/patient-data-manager/images/pdm.png', 86400, 'NONE');
